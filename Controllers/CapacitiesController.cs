...
namespace BackOffice.Controllers
{
    public class CapacitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CapacityId,CapacityDescription")] Capacity capacity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CapacityId,CapacityDescription")] Capacity capacity)
        {
            if (ModelState.IsValid)
            {
